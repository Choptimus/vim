...
" If terminal is set up with colors, use those
let s:midnightBlue=   { "gui": "#2c3e50", "cterm": "0"  } " 236
let s:clouds=         { "gui": "#ecf0f1", "cterm": "15" } " 255
let s:silver=         { "gui": "#e8e8e8", "cterm": "7" }
let s:wetAsphalt=     { "gui": "#34495e", "cterm": "8" } " 237
let s:concrete=       { "gui": "#95a5a6", "cterm": "247" } 
let s:asbestos=       { "gui": "#7f8c8d", "cterm": "245" }

let s:turquoise=      { "gui": "#1abc9c", "cterm": "14"  } " 36
let s:greenSea=       { "gui": "#16a085", "cterm": "6" } " 29
let s:emerald=        { "gui": "#2ecc71", "cterm": "10" } " 41
let s:nephritis=      { "gui": "#27ae60", "cterm": "2" } " 35

let s:peterRiver=     { "gui": "#3498db", "cterm": "12"  } " 33
let s:belizeHole=     { "gui": "#2980b9", "cterm": "4"  } " 26
let s:amethyst=       { "gui": "#9b59b6", "cterm": "13" } " 133
let s:wisteria=       { "gui": "#8e44ad", "cterm": "5" } " 97
...
let s:alizarin=       { "gui": "#e74c3c", "cterm": "9"  } " 196
let s:pomegranate=    { "gui": "#c0392b", "cterm": "1" } " 124
...
" Highlights - UI ------------------------------------------{{{
  ...
  call s:h("StatusLine",   { "fg": s:bg, "bg": s:norm, "gui": "italic", "cterm": "bold" })
