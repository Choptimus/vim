" commit ef4a37a95b96d96975357631a2e2e8ab246832e5
" vim:fdm=marker
" Vim Color File
" Name:       onedark.vim
...
call s:h("SignColumn", { "bg": s:comment_grey }) " column where signs are displayed
call s:h("IncSearch", { "fg": s:blue, "bg": s:comment_grey }) " 'incsearch' highlighting; also used for the text replaced with ":s///c"
...
call s:h("Search", { "fg": s:black, "bg": s:blue }) " Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
...
call s:h("StatusLineNC", { "fg": s:white, "bg": s:cursor_grey }) " status line of current window
